...
/**
 * This class encodes data from an Intent into a QR code, and then displays it full
 * screen so that
...
public final class EncodeActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (intent == null) {
            ...
            if (Intents.Encode.ACTION.equals(action) || Intent.ACTION_SEND.equals
                    (action)) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        int encodeNameResource = useVcard ? R.string.menu_encode_mecard : R.string
                .menu_encode_vcard;
    ...
    private void share() {
        ...
        intent.putExtra(Intent.EXTRA_STREAM, Uri.parse("file://" + barcodeFile
                .getAbsolutePath()));
