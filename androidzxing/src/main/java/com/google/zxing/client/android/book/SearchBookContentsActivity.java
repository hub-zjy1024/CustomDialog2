...
public final class SearchBookContentsActivity extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    if (LocaleManager.isBookSearchUrl(isbn)) {
      ...
      setTitle(getString(com.google.zxing.client.android.R.string.sbc_name) + ": ISBN " + isbn);
    }
    ...
    headerView = (TextView) factory.inflate(com.google.zxing.client.android.R.layout.search_book_contents_header,
  ...
  private final class NetworkTask extends AsyncTask<String,Object,JSONObject> {
    ...
    private void handleSearchResults(JSONObject json) {
      try {
        ...
        headerView.setText(getString(com.google.zxing.client.android.R.string.msg_sbc_results) + " : " + count);
        if (count > 0) {
    ...
    private SearchBookContentsResult parseResult(JSONObject json) {
      ...
      if (pageNumber == null || pageNumber.isEmpty()) {
        ...
        pageNumber = getString(com.google.zxing.client.android.R.string.msg_sbc_page) + ' ' + pageNumber;
      }
      ...
      if (valid) {
        ...
        snippet = '(' + getString(com.google.zxing.client.android.R.string.msg_sbc_snippet_unavailable) + ')';
      }
