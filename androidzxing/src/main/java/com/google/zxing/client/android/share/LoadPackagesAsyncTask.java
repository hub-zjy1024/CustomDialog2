...
final class LoadPackagesAsyncTask extends AsyncTask<Object,Object,List<AppInfo>> {
  ...
  protected void onPostExecute(final List<AppInfo> results) {    
    ListAdapter listAdapter = new ArrayAdapter<AppInfo>(activity, 
                                                        com.google.zxing.client.android.R.layout.app_picker_list_item,
                                                        com.google.zxing.client.android.R.id.app_picker_list_item_label,
                                                        results) {
      @Override
      public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (icon != null) {
          ((ImageView) view.findViewById(com.google.zxing.client.android.R.id.app_picker_list_item_icon)).setImageDrawable(icon);
        }
        return view;
      }
    };
