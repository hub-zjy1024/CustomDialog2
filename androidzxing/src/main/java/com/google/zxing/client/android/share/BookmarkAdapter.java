...
final class BookmarkAdapter extends BaseAdapter {
  ...
  public View getView(int index, View view, ViewGroup viewGroup) {
    ...
    if (view instanceof LinearLayout) {
      ...
      layout = factory.inflate(com.google.zxing.client.android.R.layout.bookmark_picker_list_item, viewGroup, false);
    }
    String[] titleURL = titleURLs.get(index);
    ((TextView) layout.findViewById(com.google.zxing.client.android.R.id.bookmark_title)).setText(titleURL[0]);
    ((TextView) layout.findViewById(com.google.zxing.client.android.R.id.bookmark_url)).setText(titleURL[1]);
    return layout;
  }
}
