...
public final class HistoryActivity extends ListActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu,
        ...
        if (position >= adapter.getCount() || adapter.getItem(position).getResult() !=
                null) {
            menu.add(Menu.NONE, position, position, R.string
                    .history_clear_one_history_text);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int what = item.getItemId();
        if (what == R.id.menu_history_send) {
        ...
        } else if (what == R.id.menu_history_clear_text) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
