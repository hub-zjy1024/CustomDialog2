...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    @Override
    public final ILoadingLayout getLoadingLayoutProxy(boolean includeStart, boolean
            includeEnd) {
     ...
     */
    protected final void addViewInternal(View child, int index, ViewGroup.LayoutParams
            params) {
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray
            attrs) {
    ...
    protected void onRefreshing(final boolean doScroll) {
        ...
        if (doScroll) {
            if (mShowViewWhileRefreshing) {
                ...
                OnSmoothScrollFinishedListener listener = new
                        OnSmoothScrollFinishedListener() {
                            @Override
    ...
    protected final void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            mShowViewWhileRefreshing = bundle.getBoolean(STATE_SHOW_REFRESHING_VIEW,
                    true);
    ...
    protected final void refreshRefreshableViewSize(int width, int height) {
        ...
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams)
                mRefreshableViewWrapper.getLayoutParams();
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (USE_HW_LAYERS) {
             ...
             */
            ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View
                    .LAYER_TYPE_HARDWARE
     ...
     */
    protected final void smoothScrollTo(int scrollValue, OnSmoothScrollFinishedListener
            listener) {
    ...
    private void addRefreshableView(Context context, T refreshableView) {
        ...
        mRefreshableViewWrapper.addView(refreshableView, ViewGroup.LayoutParams
                        .MATCH_PARENT,
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrMode)) {
            mMode = Mode.mapIntToValue(a.getInteger(R.styleable.PullToRefresh_ptrMode,
                    0));
        }
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
            Drawable background = a.getDrawable(R.styleable
        ...
        if (a.hasValue(R.styleable.PullToRefresh_ptrOverScroll)) {
            mOverScrollEnabled = a.getBoolean(R.styleable.PullToRefresh_ptrOverScroll,
                    true);
        }
    ...
    private void pullEvent() {
        ...
        if (newScrollValue != 0 && !isRefreshing()) {
            ...
            if (mState != State.PULL_TO_REFRESH && itemDimension >= Math.abs
                    (newScrollValue)) {
                setState(State.PULL_TO_REFRESH);
            } else if (mState == State.PULL_TO_REFRESH && itemDimension < Math.abs
                    (newScrollValue)) {
    ...
    private LinearLayout.LayoutParams getLoadingLayoutLayoutParams() {
        switch (getPullToRefreshScrollDirection()) {
            case HORIZONTAL:
                return new LinearLayout.LayoutParams(LinearLayout.LayoutParams
                        .WRAP_CONTENT,
    ...
    private final void smoothScrollTo(int newScrollValue, long duration, long delayMillis,
        ...
        if (oldScrollValue != newScrollValue) {
            ...
            mCurrentSmoothScrollRunnable = new SmoothScrollRunnable(oldScrollValue,
    ...
    private final void smoothScrollToAndBack(int y) {
        smoothScrollTo(y, SMOOTH_SCROLL_DURATION_MS, 0, new
                OnSmoothScrollFinishedListener() {
