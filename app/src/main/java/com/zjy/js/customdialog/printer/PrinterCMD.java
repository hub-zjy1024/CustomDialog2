...
public class PrinterCMD {
    ...
    /// </summary>
    /// <returns></returns>
    public String send_Enter() {
        String cmd = String.valueOf((char) 10);
    ...
    /// <returns></returns>
    public String send_TextAlign(int align) {
    ...
    /// <returns></returns>
    public String send_FontSize(int nfontsize) {
        String _cmdstr = "";
        //设置字体大小
        switch (nfontsize) {
            case -1:
    ...
    /// <returns></returns>
    public String send_FontSize_BTP_M280(int size) {
        String _cmdstr = "";
        //只有0和1两种模式
        int fontsize = size;
    ...
    /// <param name="size">0:取消倍宽倍高模式  1:倍高模式 2:倍宽模式 3:两倍大小</param>
    /// <returns></returns>
    public String send_FontSize_BTP_M2801(int size) {
        String _cmdstr = "";
        //只有0和1两种模式
        int fontsize = size;
    ...
    /// <returns></returns>
    public String send_PageGO(int line) {
    ...
    /// 第八位：固定为0
    /// <returns></returns>
    public String get_ReturnStatus(int num) {
    ...
    /// <returns></returns>
    public String set_TiaoMaHeight(int num) {
    ...
    /// <param name="num"></param>
    /// <returns></returns>
    public String set_TiaoMaWidth(int num) {
    ...
    /// <returns></returns>
    public String set_TiaoMaWeiZi(int num) {
    ...
    /// <returns></returns>
    public String print_TiaoMa(String numstr) {
