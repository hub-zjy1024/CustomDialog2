...
public class JavaCamera2View extends CameraBridgeViewBase {
    ...
    private void createCameraPreviewSession() {
        int tempW = mPreviewSize.getWidth();
        int tempH = mPreviewSize.getHeight();
//        if (!isLandscape()) {
//            int temp = tempW;
//            tempW = tempH;
//            tempH = temp;
//        }
        final int w = tempW, h = tempH;
...
//                            mPreviewRequestBuilder.set(CaptureRequest.JPEG_ORIENTATION, CaptureRe);
    ...
    boolean calcPreviewSize(final int width, final int height) {
        ...
        try {
            ...
            Log.e(LOGTAG, "best size: " + bestWidth + "x" + bestHeight);
    ...
    protected boolean connectCamera(int width, int height) {
        ...
        try {
            ...
            Log.e("zjy", "JavaCamera2View->connectCamera(): WH==" + mFrameWidth + "\t" + mFrameHeight);
            ...
            AllocateCache();
            Log.e("zjy", "JavaCamera2View->connectCamera(): NeedConfig==");
            if (needReconfig) {
                if (null != mCaptureSession) {
